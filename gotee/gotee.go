...
var contract_table_path = "/home/fdokic/Downloads/con0.csv"
var result_file_dir = "/home/fdokic/dev/teether/results/"
...
func checkContract(i int, c chan int, str []string, wg *sync.WaitGroup) {
	...
	defer cancel()
	if err := exec.CommandContext(ctx, "python", teether_path+"bin/gen_exploit.py", code, "0x1234", "0x1000", "+1000", result_file_dir+fmt.Sprint(i)+".txt", str[0]).Run(); err != nil {
		fmt.Println("timeout: " + fmt.Sprint(i))
		<-c
		return
	}
	/*
